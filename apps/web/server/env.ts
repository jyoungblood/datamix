...
type GeneratedDatamixBindings = Pick<
  Env,
  | "APP_ORIGIN"
  | "APP_ENV"
  | "DB"
...
export function readApiRuntime(env: DatamixBindings): ApiRuntimeEnv {
  return {
...
export function readApiAuthRuntime(env: DatamixBindings): ApiAuthRuntimeEnv {
...
export function readPublicApiRuntime(env: DatamixBindings): PublicApiRuntimeEnv {
