...
async function resolveCollectionRecordContext(env: DatamixBindings, collectionName: string) {
...
export async function listCollectionRecords(env: DatamixBindings, collectionName: string) {
...
export async function listGeneratedCollectionCrudRoutes(env: DatamixBindings) {
  const collections = await listCollectionDefinitions(env);

  return collections.map(formatGeneratedCollectionCrudRoute);
}

export async function listPublicCollectionCrudRoutes(env: DatamixBindings) {
  const collections = await listCollectionDefinitions(env);
