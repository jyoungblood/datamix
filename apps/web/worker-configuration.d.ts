/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts --config wrangler.jsonc --env-file .dev.vars.example` (hash: ae0306ced88c6e3c701acac3cf456951)
