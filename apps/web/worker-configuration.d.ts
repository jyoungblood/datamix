/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts --config wrangler.jsonc --env-file .dev.vars.example` (hash: c56bb4c56e2a1360617087eef5f2f8cd)
