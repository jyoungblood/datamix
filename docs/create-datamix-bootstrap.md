...
- Rewrites Cloudflare resource names in `apps/web/wrangler.jsonc` to match the new project slug.
- Prints the single deployed-app Cloudflare provisioning commands when `--deploy` is passed.
